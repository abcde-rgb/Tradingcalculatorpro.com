...
| `identidad-visual` | Usar al tocar cualquier cosa visual de TradingCalculator.Pro: colores, tipografías, espaciados, tamaños, bordes, sombras, layout de una página, la… | 227 |
...
|---|---|---|
| `rules/backend.md` | `backend/*.py`<br>`backend/**/*.py` | 143 |
