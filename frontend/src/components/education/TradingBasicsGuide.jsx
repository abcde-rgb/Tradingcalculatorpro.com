...
function CompareRow({ label, long, short }) {
  return (
    <tr className="border-b border-border last:border-0">
      ...
      <td className="py-2 px-3 text-xs text-green-400">{long}</td>
      <td className="py-2 px-3 text-xs text-red-400">{short}</td>
    </tr>
  );
}
...
export default function TradingBasicsGuide() {
  ...
  const sections = [
    { id: 'long',      label: t('basicsLongLabel'),   icon: TrendingUp,   color: 'text-green-400' },
    { id: 'short',     label: t('basicsShortLabel'),  icon: TrendingDown, color: 'text-red-400'   },
    { id: 'tp',        label: t('takeProfit'),         icon: Target,       color: 'text-emerald-400' },
    { id: 'sl',        label: t('stopLoss'),           icon: Shield,       color: 'text-orange-400' },
    { id: 'positions', label: t('positionSize'),       icon: Layers,       color: 'text-cyan-400' },
  ];
    ...
    <div className="space-y-8">
          ...
          <Card className="border-green-500/30 bg-green-500/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-green-400">
                ...
                {t('basicsLongTitle')}
                <Badge className="ml-auto bg-green-500/20 text-green-400 border-green-500/30">{t('basicsLongBadge')}</Badge>
              </CardTitle>
            </CardHeader>
          ...
          <Card className="border-red-500/30 bg-red-500/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-red-400">
                ...
                {t('basicsShortTitle')}
                <Badge className="ml-auto bg-red-500/20 text-red-400 border-red-500/30">{t('basicsShortBadge')}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="p-3 rounded-lg bg-orange-500/10 border border-orange-500/30 flex gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  <strong className="text-orange-400">{t('basicsImportant')}</strong> {t('basicsShortWarning')}
                </p>
              </div>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="bg-muted/30 text-xs font-semibold">
                        ...
                        <th className="py-2 px-3 text-green-400">Long ↑</th>
                        <th className="py-2 px-3 text-red-400">Short ↓</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <Card className="border-emerald-500/30 bg-emerald-500/5">
            ...
            <CardContent className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { icon: CheckCircle, color: 'text-green-400', titleKey: 'basicsTpBen1Title', descKey: 'basicsTpBen1Desc' },
                  { icon: CheckCircle, color: 'text-green-400', titleKey: 'basicsTpBen2Title', descKey: 'basicsTpBen2Desc' },
                  { icon: CheckCircle, color: 'text-green-400', titleKey: 'basicsTpBen3Title', descKey: 'basicsTpBen3Desc' },
                  { icon: CheckCircle, color: 'text-green-400', titleKey: 'basicsTpBen4Title', descKey: 'basicsTpBen4Desc' },
          ...
          <Card className="border-orange-500/30 bg-orange-500/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-orange-400">
                ...
                {t('basicsSlTitle')}
                <Badge className="ml-auto bg-red-500/20 text-red-400 border-red-500/30">{t('basicsSlBadge')}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30 flex gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-red-400 mb-1">{t('basicsSlGoldenTitle')}</p>
                  <p className="text-xs text-muted-foreground leading-relaxed">{t('basicsSlGoldenRule')}</p>
                </div>
              </div>
              <div>
                <h3 className="font-semibold text-sm mb-3 flex items-center gap-2">
                  <Shield className="w-4 h-4 text-orange-400" /> {t('basicsSlTypesTitle')}
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    { titleKey: 'basicsSlT1Title', descKey: 'basicsSlT1Desc', badgeKey: 'basicsSlT1Badge', badgeColor: 'bg-green-500/20 text-green-400 border-green-500/30' },
                    { titleKey: 'basicsSlT2Title', descKey: 'basicsSlT2Desc', badgeKey: 'basicsSlT2Badge', badgeColor: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
                    { titleKey: 'basicsSlT3Title', descKey: 'basicsSlT3Desc', badgeKey: 'basicsSlT3Badge', badgeColor: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
                    { titleKey: 'basicsSlT4Title', descKey: 'basicsSlT4Desc', badgeKey: 'basicsSlT4Badge', badgeColor: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
              ...
              <div>
                <h3 className="font-semibold text-sm mb-3 flex items-center gap-2">
                  <XCircle className="w-4 h-4 text-red-400" /> {t('basicsSlErrorsTitle')}
                </h3>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={eKey} className="p-3 rounded-lg bg-card border border-border">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs font-semibold text-red-400">{t(eKey)}</p>
                      </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-card border border-orange-500/20">
                  <p className="text-xs font-semibold text-orange-400 mb-2">{t('basicsSlFormula1Title')}</p>
                ...
                <div className="p-4 rounded-lg bg-card border border-red-500/20">
                  <p className="text-xs font-semibold text-red-400 mb-2">{t('basicsSlFormula2Title')}</p>
          ...
          <Card className="border-cyan-500/30 bg-cyan-500/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-cyan-400">
                ...
                {t('basicsPosTitle')}
                <Badge className="ml-auto bg-cyan-500/20 text-cyan-400 border-cyan-500/30">{t('basicsPosBadge')}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-3 flex items-center gap-2">
                  <Layers className="w-4 h-4 text-cyan-400" /> {t('basicsPosTableTitle')}
                </h3>
                <div className="rounded-lg border border-border overflow-hidden">
                  <table className="w-full text-left">
                    <thead>
                    ...
                    <tbody>
                      {[
                        ...
                        { nameKey: 'basicsMiniName',  lot: '0.1',  units: '10.000', pip: '~$1.00', accountKey: 'basicsMiniAccount',  color: 'text-cyan-400',  badgeKey: 'basicsMiniNBadge', badgeColor: 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30' },
                        ...
                        { nameKey: 'basicsMacroName', lot: '10+',  units: '1.000.000+', pip: '~$100+', accountKey: 'basicsMacroAccount', color: 'text-purple-400', badgeKey: 'basicsMacroBadge', badgeColor: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { titleKey: 'basicsMicroTitle', unitsKey: 'basicsMicroUnits', descKey: 'basicsMicroDesc', formula: '1 pip = $0.10', formula2: '100 pips = $10 | SL 50 pips → −$5', tipKey: 'basicsMicroTip', tipIcon: CheckCircle, tipColor: 'text-green-400', borderColor: 'border-sky-500/30 bg-sky-500/5', titleColor: 'text-sky-400', badgeColor: 'bg-sky-500/20 text-sky-400 border-sky-500/30', badgeKey: 'basicsMicroUnits' },
                  { titleKey: 'basicsMiniTitle',  unitsKey: 'basicsMiniUnits',  descKey: 'basicsMiniDesc',  formula: '1 pip = $1.00', formula2: '100 pips = $100 | SL 50 pips → −$50', tipKey: 'basicsMiniTip',  tipIcon: CheckCircle, tipColor: 'text-green-400', borderColor: 'border-cyan-500/30 bg-cyan-500/5', titleColor: 'text-cyan-400', badgeColor: 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30',  badgeKey: 'basicsMiniUnits' },
                  { titleKey: 'basicsStdTitle',   unitsKey: 'basicsStdUnits',   descKey: 'basicsStdDesc',   formula: '1 pip = $10.00', formula2: '100 pips = $1.000 | SL 50 pips → −$500', tipKey: 'basicsStdWarning', tipIcon: AlertTriangle, tipColor: 'text-orange-400', borderColor: 'border-teal-500/30 bg-teal-500/5', titleColor: 'text-teal-400', badgeColor: 'bg-teal-500/20 text-teal-400 border-teal-500/30',  badgeKey: 'basicsStdUnits' },
                  { titleKey: 'basicsMacroTitle', unitsKey: 'basicsMacroUnits', descKey: 'basicsMacroDesc', formula: '10 lotes: 1 pip = $100', formula2: '100 lotes: 1 pip = $1.000', tipKey: 'basicsMacroInfo', tipIcon: Info, tipColor: 'text-blue-400', borderColor: 'border-purple-500/30 bg-purple-500/5', titleColor: 'text-purple-400', badgeColor: 'bg-purple-500/20 text-purple-400 border-purple-500/30', badgeKey: 'basicsMacroUnits' },
              ...
              <div>
                <h3 className="font-semibold text-sm mb-3 flex items-center gap-2">
                  <Percent className="w-4 h-4 text-cyan-400" /> {t('basicsPosFormulaTitle')}
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-card border border-cyan-500/20 space-y-2">
                    <p className="text-xs font-semibold text-cyan-400">{t('basicsPosFormulaLabel')}</p>
                    ...
                    <div className="border-t border-border pt-2 space-y-1">
                      ...
                      <p className="font-mono text-xs text-cyan-400">{t('basicsPosFormulaExResult')}</p>
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-card border border-border space-y-2">
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        { capital: '$1.000',  risk: '1% = $10',  lot: '0.1 mini',     color: 'text-cyan-400' },
                        { capital: '$5.000',  risk: '1% = $50',  lot: '0.5 mini',     color: 'text-cyan-400' },
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30 flex gap-3">
                <AlertTriangle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-semibold text-red-400 mb-1">{t('basicsPosWarningTitle')}</p>
      ...
      <Card className="bg-gradient-to-br from-card to-muted/20 border-border">
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              { color: 'border-green-500/40 bg-green-500/5',   icon: TrendingUp,   iconColor: 'text-green-400',   title: 'LONG',  descKey: 'basicsSummaryLongDesc' },
              { color: 'border-red-500/40 bg-red-500/5',       icon: TrendingDown, iconColor: 'text-red-400',     title: 'SHORT', descKey: 'basicsSummaryShortDesc' },
              { color: 'border-emerald-500/40 bg-emerald-500/5', icon: Target,     iconColor: 'text-emerald-400', title: 'TP',    descKey: 'basicsSummaryTpDesc' },
              { color: 'border-orange-500/40 bg-orange-500/5', icon: Shield,       iconColor: 'text-orange-400',  title: 'SL',    descKey: 'basicsSummarySlDesc' },
              { color: 'border-cyan-500/40 bg-cyan-500/5',     icon: Layers,       iconColor: 'text-cyan-400',    titleKey: 'basicsSummaryLotsTitle', descKey: 'basicsSummaryLotsDesc' },
