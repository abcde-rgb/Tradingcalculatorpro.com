    ...
    <Card className="bg-card border-border" data-testid="speakers-watch">
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center gap-2 text-base">
          <Megaphone className="w-4 h-4 text-warn" /> {t('speakersTitle')}
        </CardTitle>
      </CardHeader>
      <CardContent>
            ...
            <li key={s.id}>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-muted-foreground group-hover:text-warn transition-colors shrink-0" />
                </div>
