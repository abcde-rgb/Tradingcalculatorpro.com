...
import RRGVisual from '@/components/education/RRGVisual';
import PitchforkVisual from '@/components/education/PitchforkVisual';
import BillWilliamsVisual from '@/components/education/BillWilliamsVisual';
...
export default function EducationPage() {
  ...
  const ORDER_FLOW = getOrderFlow(t);
  const COMPANY_VALUATION = getCompanyValuation(t);
      ...
      <main className="pt-24 pb-12 px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <Tabs value={activeTopic} onValueChange={setActiveTopic}>
            ...
            {/* Order flow — reading the raw buy/sell pressure */}
            <TabsContent value="order-flow" className="space-y-8">
              <Card className="bg-gradient-to-br from-blue-500/5 to-primary/10 border-blue-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{ORDER_FLOW.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {ORDER_FLOW.items.map((item) => (
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{ORDER_FLOW.note}</p>
              </div>
            </TabsContent>

            {/* Company valuation — reading the financials, moat, multiples & DCF */}
            <TabsContent value="company-valuation" className="space-y-8">
              <Card className="bg-gradient-to-br from-emerald-500/5 to-primary/10 border-emerald-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{COMPANY_VALUATION.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {COMPANY_VALUATION.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <CompanyValuationVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{COMPANY_VALUATION.note}</p>
              </div>
            </TabsContent>

            {/* Macro — cycle, rates, yield curve & sector rotation */}
            <TabsContent value="macro" className="space-y-8">
              <Card className="bg-gradient-to-br from-blue-500/5 to-indigo-500/10 border-blue-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{MACRO.intro}</p>
                </CardContent>
              </Card>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{MACRO.note}</p>
              </div>
            </TabsContent>

            {/* Market structure — HH/HL, BOS, CHOCH, accumulation/distribution */}
            <TabsContent value="market-structure" className="space-y-8">
              <Card className="bg-gradient-to-br from-primary/5 to-emerald-500/10 border-primary/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-unbounded text-2xl">
                    ...
                    {MARKET_STRUCTURE.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{MARKET_STRUCTURE.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {MARKET_STRUCTURE.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <MarketStructureVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{MARKET_STRUCTURE.note}</p>
              </div>
            </TabsContent>

            {/* Sessions & seasonality — time-of-day and calendar tendencies */}
            <TabsContent value="session-timing" className="space-y-8">
              <Card className="bg-gradient-to-br from-amber-500/5 to-primary/10 border-amber-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{SESSION_TIMING.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {SESSION_TIMING.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <SessionTimingVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
            ...
            {/* Relative Rotation Graphs — axes, quadrants, rotation, tails, use, limits */}
            <TabsContent value="rrg" className="space-y-8">
              <Card className="bg-gradient-to-br from-indigo-500/5 to-primary/10 border-indigo-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{RRG_G.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {RRG_G.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <RRGVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
            ...
            <TabsContent value="pitchfork" className="space-y-8">
              <Card className="bg-gradient-to-br from-emerald-500/5 to-primary/10 border-emerald-500/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-unbounded text-2xl">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{PITCHFORK.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {PITCHFORK.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <PitchforkVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{PITCHFORK.note}</p>
              </div>
            </TabsContent>

            {/* Bill Williams / Trading Chaos — Alligator, fractals, AO, Gator/MFI, use, limits */}
            <TabsContent value="bill-williams" className="space-y-8">
              <Card className="bg-gradient-to-br from-lime-500/5 to-primary/10 border-lime-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{BILL_WILLIAMS.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {BILL_WILLIAMS.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <BillWilliamsVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{BILL_WILLIAMS.note}</p>
              </div>
            </TabsContent>

            {/* Wolfe Waves — structure, target line, rules, use, honest subjective limits */}
            <TabsContent value="wolfe-waves" className="space-y-8">
              <Card className="bg-gradient-to-br from-orange-500/5 to-primary/10 border-orange-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{WOLFE.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {WOLFE.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <WolfeWavesVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{WOLFE.note}</p>
              </div>
            </TabsContent>

            {/* Market Profile & Auction — TPO, value area/POC, initial balance, use, limits */}
            <TabsContent value="market-profile" className="space-y-8">
              <Card className="bg-gradient-to-br from-teal-500/5 to-primary/10 border-teal-500/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-unbounded text-2xl">
                    <BarChartHorizontal className="w-6 h-6 text-teal-500" />
                    {MARKET_PROFILE.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{MARKET_PROFILE.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {MARKET_PROFILE.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <MarketProfileVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
                <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground leading-relaxed">{MARKET_PROFILE.note}</p>
              </div>
            </TabsContent>

            {/* Elder system — 3 Ms, Triple Screen, Elder-Ray, Force Index, Impulse, limits */}
            <TabsContent value="elder" className="space-y-8">
              <Card className="bg-gradient-to-br from-purple-500/5 to-primary/10 border-purple-500/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{ELDER.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {ELDER.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <ElderVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
            ...
            <TabsContent value="psych-solutions" className="space-y-8">
              <Card className="bg-gradient-to-br from-violet-500/5 to-primary/10 border-violet-500/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-unbounded text-2xl">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">{PSYCH_SOLUTIONS.intro}</p>
                </CardContent>
              </Card>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {PSYCH_SOLUTIONS.items.map((item) => (
                  <Card key={item.id} className="bg-card border-border hover:border-primary/40 transition-colors">
                    <CardContent className="p-5">
                      <h3 className="font-semibold mb-1.5">{item.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{item.desc}</p>
                      <PsychSolutionsVisual id={item.id} />
                    </CardContent>
                  </Card>
                ))}
              </div>
