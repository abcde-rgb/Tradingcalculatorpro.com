  ...
  forex: {
    es: {
      ...
      measure: [
        ...
        { k: 'Nocional', v: 'Lotes × tamaño del lote = exposición en la divisa BASE. Multiplicado además por el precio, la misma exposición expresada en la divisa COTIZADA. Las dos son tu exposición real, no lo que depositas; lo que no vale es mezclarlas.' },
      ...
      example: {
        ...
        rows: [
          ['Cuenta', '5.000 €'],
          ['Riesgo por operación', '1% = 50 € → 54,25 $ (a 1,0850)'],
          ['Par', 'EUR/USD a 1,0850'],
          ['Stop loss', '25 pips'],
          ['Valor del pip (1 lote estándar)', '10 $'],
          ['Tamaño máximo', '54,25 $ ÷ (25 pips × 10 $) = 0,217 lotes'],
          ['Nocional controlado', '0,217 × 100.000 = 21.700 € en base (23.545 $ al cambio) — 4,3× tu cuenta'],
        ],
        note: 'Dos cosas. La primera: el riesgo está en euros y el valor del pip en dólares, así que hay que convertir ANTES de dividir — saltarse ese paso es el error de unidades más común al dimensionar en forex, y aquí habría dado 0,20 lotes en vez de 0,217. La segunda: con un riesgo prudente del 1% ya estás moviendo más de cuatro veces tu cuenta. Ahí es donde el apalancamiento deja de ser abstracto.',
      },
      faq: [
    ...
    en: {
      ...
      measure: [
        ...
        { k: 'Notional', v: 'Lots × lot size = exposure in the BASE currency. Multiply by price and you get the same exposure in the QUOTE currency. Both are your real exposure — not what you deposit; what you must not do is mix them.' },
      ...
      example: {
        ...
        rows: [
          ['Account', '€5,000'],
          ['Risk per trade', '1% = €50 → $54.25 (at 1.0850)'],
          ['Pair', 'EUR/USD at 1.0850'],
          ['Stop loss', '25 pips'],
          ['Pip value (1 standard lot)', '$10'],
          ['Maximum size', '$54.25 ÷ (25 pips × $10) = 0.217 lots'],
          ['Notional controlled', '0.217 × 100,000 = €21,700 in base ($23,544.50 at the rate) — 4.3× your account'],
        ],
        note: 'Two things. First: the risk is in euros and the pip value in dollars, so you convert BEFORE dividing — skipping that step is the most common unit error in forex sizing, and here it would have given 0.20 lots instead of 0.217. Second: a conservative 1% risk already has you moving more than four times your account. That is the point where leverage stops being an abstraction.',
      },
      faq: [
    ...
    es: {
      ...
      example: {
        ...
        rows: [
          ...
          ['Plazo', '20 años'],
          ['ETF barato (TER 0,07%)', '10.000 × 1,0693²⁰ = 38.194 €'],
          ['ETF caro (TER 0,70%)', '10.000 × 1,0630²⁰ = 33.936 €'],
          ['Diferencia', '4.257 € — el 11,1% de tu resultado, solo en comisiones'],
        ],
    ...
    en: {
      ...
      example: {
        ...
        rows: [
          ...
          ['Horizon', '20 years'],
          ['Cheap ETF (TER 0.07%)', '10,000 × 1.0693²⁰ = €38,194'],
          ['Expensive ETF (TER 0.70%)', '10,000 × 1.0630²⁰ = €33,936'],
          ['Difference', '€4,257 — 11.1% of your result, in fees alone'],
        ],
  ...
  cfds: {
    es: {
      ...
      measure: [
        ...
        { k: 'Margen', v: 'Lo que bloquea el bróker. En la UE, ESMA limita el apalancamiento minorista: 30:1 en majors de forex, 20:1 en índices principales, oro y divisas no principales, 10:1 en el resto de materias primas e índices secundarios, 5:1 en acciones y 2:1 en cripto.' },
    ...
    en: {
      ...
      measure: [
        ...
        { k: 'Margin', v: 'What the broker locks up. In the EU, ESMA caps retail leverage: 30:1 on major forex, 20:1 on major indices, gold and non-major currencies, 10:1 on other commodities and non-major indices, 5:1 on single shares and 2:1 on crypto.' },
