# Catálogo de análisis técnico avanzado / olvidado (backlog de contenido)

> **Propósito.** Rescatar técnicas de análisis **gráfico y técnico avanzado** con
...
## 1. Wyckoff y teoría de subasta
1. **Spring** — barrida falsa bajo soporte → giro alcista. ✅🔨
2. **Upthrust / UTAD** — barrida falsa sobre resistencia → giro bajista. ✅🔨
3. **Esquema de acumulación** (fases A–E). ✅🔨
4. **Esquema de distribución** (fases A–E). ✅🔨
5. **Sign of Strength / Sign of Weakness** (SOS/SOW). ✅🔨
6. **Last Point of Support / Supply** (LPS/LPSY). ✅🔨
7. **Selling/Buying Climax** (clímax). ✅🔨
8. **Automatic Rally / Automatic Reaction**. ✅🔨
9. **Secondary Test**. ✅🔨
10. **Ley Esfuerzo vs Resultado** (volumen vs rango). ✅🔨
11. **Ley Causa-Efecto** (conteo horizontal P&F → objetivo). ✅🔨
12. **Composite Operator** (lectura de la mano fuerte). ⚠️🔨

## 2. Market / Volume Profile (Steidlmayer, Dalton)
13. **Point of Control (POC)**. ✅🔨
14. **Value Area 70%** (VAH/VAL). ✅🔨
15. **Naked / Virgin POC** (POC sin testear → imán). ✅🔨
16. **Single prints / excess**. ✅🔧
17. **Poor high / poor low** (extremos débiles). ✅🔧
18. **Initial Balance** (rango de la primera hora). ✅🔧
19. **Perfiles b / P / D** (balance vs desequilibrio). ✅🔧
20. **Migración del Value Area** día a día. ✅🔨
21. **Perfil compuesto multi-día**. ✅🔨
22. **Tipos de apertura** (open-drive/test/rejection). ⚠️🔧
23. **Volume POC vs TPO POC**. ✅🔧
24. **HVN / LVN** (nodos de alto/bajo volumen). ✅🔨
25. **VWAP de sesión**. ✅🔨
26. **Anchored VWAP** (anclado a evento clave). ✅🔨
27. **Bandas de desviación del VWAP**. ✅🔨
28. **VWAP semanal/mensual rodante**. ✅🔨

## 3. Order flow / microestructura
29. **Cumulative Volume Delta (CVD)**. ✅🔧
30. **Footprint / imbalance de delta**. ✅🔧
31. **Absorción** (mucho volumen, poco movimiento). ✅🔧
32. **Divergencia de delta en extremos**. ✅🔧
33. **Imbalances apilados**. ✅🔧
34. **Detección de icebergs**. ⚠️🔧
35. **Lectura de DOM / tells de spoofing**. ⚠️🔧
36. **Barrido de liquidez / caza de stops**. ✅🔨 (aprox. con mechas)
37. **Lectura de cinta (time & sales)**. ⚠️🔧

## 4. DeMark (respetado por instituciones, ignorado por retail)
38. **TD Sequential — Setup (9)**. ✅🔨
39. **TD Sequential — Countdown (13)**. ✅🔨
40. **TD Combo**. ✅🔨
41. **TD Lines** (oferta/demanda). ✅🔨
42. **TDST** (niveles de Setup Trend). ✅🔨
43. **TD REI / TD Pressure**. ⚠️🔨

## 5. Amplitud de mercado / internals
44. **Línea Avance-Descenso (A-D)**. ✅🔧
45. **Oscilador McClellan**. ✅🔧
46. **McClellan Summation Index**. ✅🔧
47. **TRIN / Arms Index**. ✅🔧
48. **Nuevos Máximos − Nuevos Mínimos**. ✅🔧
49. **% de valores sobre la MM200**. ✅🔧
50. **A-D Volume line**. ✅🔧
51. **Zweig Breadth Thrust**. ✅🔧
52. **Hindenburg Omen**. ⚠️🔧
53. **Divergencia de amplitud en techos**. ✅🔧

## 6. Intermercado y fuerza relativa
54. **Análisis intermercado** (bonos/acciones/materias/dólar — Murphy). ✅🔧
55. **Línea de Fuerza Relativa (RS, no RSI)**. ✅🔨
56. **Relative Rotation Graphs (RRG)**. ✅🔧
57. **Ratio charts** (SPX/oro, cobre/oro…). ✅🔧
58. **Curva de tipos como filtro de régimen**. ✅🔧
59. **Spreads de crédito (HYG/LQD)** risk-on/off. ✅🔧

## 7. Price action y estructura avanzada
60. **2B / test fallido** (Sperandeo). ✅🔨
61. **Fade de falso rompimiento**. ✅🔨
62. **Turtle Soup** (Raschke — falso rompimiento del extremo de 20). ✅🔨
63. **Wolfe Waves** (5 puntos con línea objetivo EPA). ⚠️🔨
64. **Three-Drive**. ⚠️🔨
65. **Pitchfork de Andrews (median line)**. ⚠️🔨
66. **Variante Schiff / pitchfork modificado**. ⚠️🔨
67. **Ross Hook** (Joe Ross). ✅🔨
68. **1-2-3 reversal** (Ross/Sperandeo). ✅🔨
69. **Hikkake** (LeBeau — inside bar con falso rompimiento). ✅🔨
70. **NR7 / NR4** (contracción de rango — Crabel). ✅🔨
71. **ID/NR4** (inside day + NR4). ✅🔨
72. **Opening Range Breakout** (Crabel). ✅🔧
73. **Key reversal bar / island reversal**. ✅🔨
74. **Taxonomía de gaps** (breakaway/runaway/exhaustion). ✅🔨
75. **Estadística de relleno de gaps**. ✅🔨
76. **Wide Range Bar analysis**. ✅🔨
77. **Pivotes de suelo + Camarilla + Woodie**. ✅🔨
78. **Confluencia / cluster de Fibonacci**. ⚠️🔨
79. **Measured Move / AB=CD**. ✅🔨
80. **Armónicos** (Gartley/Bat/Butterfly/Crab/Shark/Cypher). ⚠️🔨 *(ya tienes las figuras)*

## 8. Smart Money Concepts / ICT (moderno pero mal usado)
81. **Order Block**. ⚠️🔨
82. **Breaker Block**. ⚠️🔨
83. **Fair Value Gap / imbalance**. ✅🔨 *(ya lo tienes en el escáner)*
84. **Liquidity void / liquidity pool**. ⚠️🔨
85. **Quasimodo / Over-Under (QM)**. ⚠️🔨
86. **Optimal Trade Entry (OTE, Fib 0.62–0.79)**. ⚠️🔨

## 9. Volumen (más allá del perfil)
87. **VSA — No Demand**. ✅🔨
88. **VSA — No Supply**. ✅🔨
89. **VSA — Stopping Volume**. ✅🔨
90. **VSA — Clímax de compra/venta**. ✅🔨
91. **OBV + divergencias** (Granville). ✅🔨
92. **Línea Acumulación/Distribución** (Chaikin). ✅🔨
93. **Chaikin Money Flow**. ✅🔨
94. **Money Flow Index** (RSI de volumen). ✅🔨
95. **Ease of Movement** (Arms). ✅🔨
96. **Negative / Positive Volume Index** (Fosback). ✅🔨
97. **Klinger Volume Oscillator**. ✅🔨

## 10. Volatilidad y canales
98. **Bollinger Squeeze** (bandwidth mínimo → expansión). ✅🔨
99. **Bollinger %B + divergencia**. ✅🔨
100. **TTM Squeeze** (Bollinger dentro de Keltner — Carter). ✅🔨
101. **Canales de Donchian / breakout** (sistema Turtle). ✅🔨
102. **Chandelier Exit / stops por ATR**. ✅🔨
103. **Volatility Contraction Pattern (VCP — Minervini)**. ✅🔨
104. **Keltner Channels**. ✅🔨

## 11. Tipos de gráfico que filtran ruido (casi extintos)
105. **Point & Figure** (conteos vertical/horizontal → objetivos). ✅🔨
106. **Renko**. ✅🔨
107. **Kagi**. ✅🔨
108. **Three-Line Break**. ✅🔨
109. **Heikin-Ashi** (claridad de tendencia). ✅🔨
110. **Range bars**. ✅🔨

## 12. Medias y sistemas de tendencia (avanzados/olvidados)
111. **Ichimoku completo** (Kumo, Chikou, giro de nube futura). ✅🔨
112. **Guppy MMA (GMMA)**. ✅🔨
113. **Hull MA**. ✅🔨
114. **KAMA** (Kaufman adaptativa). ✅🔨
115. **Coppock Curve** (suelos de largo plazo). ✅🔨
116. **Cruce dorado/muerte con filtro de amplitud**. ✅🔧
117. **Displaced MA / envelopes**. ✅🔨

## 13. Ehlers / DSP (cuantitativo, obscuro)
118. **Fisher Transform** (Ehlers). ✅🔨
119. **Roofing Filter** (Ehlers). ⚠️🔨
120. **Sinewave / MESA** (Ehlers). ⚠️🔨
121. **Laguerre RSI / filtro**. ✅🔨
122. **Instantaneous Trendline** (Ehlers). ⚠️🔨

## 14. Osciladores (uso original olvidado)
123. **RSI — failure swings** (Wilder original, no sobrecompra/venta). ✅🔨
124. **RSI(2) / mean reversion** (Connors). ✅🔨
125. **Connors RSI**. ✅🔨
126. **CCI — rupturas ±100 y línea cero** (Lambert). ✅🔨
127. **Elder Impulse + Elder Ray** (Bull/Bear Power). ✅🔨
128. **Stochastic Pop** (Bernstein — momentum, no reversión). ✅🔨
129. **ADX/DMI como filtro de régimen** (Wilder). ✅🔨
130. **Vortex Indicator**. ✅🔨
131. **Aroon**. ✅🔨
132. **TRIX**. ✅🔨
133. **Schaff Trend Cycle**. ✅🔨
134. **Awesome Oscillator + saucer** (Williams). ✅🔨
135. **Ultimate Oscillator** (Williams). ✅🔨
...
## ❌ Descartar (para separar el humo — no venderlo como "alta probabilidad")
- **Gann** (ángulos, Square of 9, cuadratura tiempo-precio) — mayormente infalsable.
- **Bradley Siderograph**, **astro-trading**, **fases lunares** — sin base.
- **Elliott Wave sin reglas duras** — demasiado elástico/subjetivo (⚠️ solo con conteo reglado).

---

## Prioridad de construcción — Fase 1 (todo 🔨 sobre tu OHLCV)
Máxima probabilidad + máxima diferenciación + ya construible con lo que tienes:

1. **Volume Profile** — POC + Value Area + naked POC.
2. **Detector de falso rompimiento** — 2B / Spring / Upthrust (extiende el escáner actual).
3. **Anchored VWAP** — anclado a máximos/mínimos/gaps clave.
...
Oscilador McClellan, A-D line, TRIN, nuevos máx/mín, CVD/footprint, Initial Balance.

---

*Fuentes de referencia: Wyckoff; Steidlmayer & Dalton (Market Profile); T. DeMark;
Sherman McClellan; J. Murphy (intermercado); Sperandeo; L. Raschke; T. Crabel;
Tom Williams (VSA); J. Granville; M. Minervini (VCP); J. Bollinger; J. Ehlers;
L. Connors; W. Wilder. Todas las tasas se calcularán y mostrarán sobre datos reales.*
