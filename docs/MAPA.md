...
| Líneas de Python (backend) | 28,511 |
| Rutas declaradas | 205 |
| **Rutas sin consumidor en el frontend** | **33** |
| Ficheros de test · funciones de test | 69 · 1143 |
| Rutas del frontend (`App.js`) | 29 |
| Idiomas · claves i18n (referencia `es`) | 10 · 7,429 |
...
|---|---|---|
| `POST` | `/api/admin/subscriptions/{user_id}/refund` | `backend/server.py:9501` |
...
| `POST` | `/api/calculate/volatility-size` | `backend/server.py:8299` |
...
| `POST` | `/api/performance/portfolio-risk` | `backend/server.py:8257` |
...
| `GET` | `/api/quote/{symbol}` | `backend/server.py:10015` |
...
| `stock_data.py` | 822 |  | Stock data provider — hits Yahoo Finance's JSON API directly (via curl_cffi |
...
|---|---|---:|:---:|
| `GET` | `/` | 5729 | ✅ |
| `GET` | `/admin/audit-log` | 9434 | ✅ |
| `GET` | `/admin/coupons` | 10152 | ✅ |
| `POST` | `/admin/coupons` | 10158 | ✅ |
| `POST` | `/admin/coupons/{coupon_id}/toggle` | 10181 | ✅ |
| `GET` | `/admin/feature-flags` | 10201 | ✅ |
| `PATCH` | `/admin/feature-flags/{flag_id}` | 10210 | ✅ |
| `POST` | `/admin/impersonate/{user_id}` | 9471 | ✅ |
| `GET` | `/admin/market-data-health` | 9995 | ✅ |
| `GET` | `/admin/metrics` | 8689 | ✅ |
| `POST` | `/admin/payments/manual` | 9809 | ✅ |
| `GET` | `/admin/payments/reconciliation` | 9653 | ✅ |
| `GET` | `/admin/payments/webhook-health` | 9949 | ✅ |
| `POST` | `/admin/payments/{transaction_id}/grant` | 9741 | ✅ |
| `POST` | `/admin/promote` | 8737 | ✅ |
| `GET` | `/admin/revenue` | 9534 | ✅ |
| `GET` | `/admin/settings` | 9183 | ✅ |
| `PUT` | `/admin/settings` | 9207 | ✅ |
| `POST` | `/admin/subscriptions/{user_id}/refund` | 9501 | ❌ |
| `GET` | `/admin/usage` | 10031 | ✅ |
| `GET` | `/admin/usage-heatmap` | 10098 | ✅ |
| `GET` | `/admin/users` | 8589 | ✅ |
| `POST` | `/admin/users` | 8811 | ✅ |
| `GET` | `/admin/users.csv` | 8659 | ✅ |
| `DELETE` | `/admin/users/{user_id}` | 8925 | ✅ |
| `PATCH` | `/admin/users/{user_id}` | 8856 | ✅ |
| `POST` | `/admin/users/{user_id}/reset-password` | 8960 | ✅ |
| `GET` | `/admin/webhooks` | 10225 | ✅ |
| `POST` | `/admin/webhooks/{event_id}/retry` | 10231 | ✅ |
| `GET` | `/alerts` | 4158 | ✅ |
| `POST` | `/alerts` | 4144 | ✅ |
| `POST` | `/alerts/send-email` | 4284 | ❌ |
| `DELETE` | `/alerts/{alert_id}` | 4166 | ✅ |
| `POST` | `/analytics/track` | 10071 | ✅ |
...
| `GET` | `/backtest/strategies` | 8235 | ✅ |
| `POST` | `/backtest/validate` | 8164 | ✅ |
...
| `POST` | `/calculate/volatility-size` | 8299 | ❌ |
...
| `GET` | `/performance/analytics` | 8317 | ✅ |
| `GET` | `/performance/instruments` | 7977 | ✅ |
| `POST` | `/performance/portfolio-risk` | 8257 | ❌ |
| `GET` | `/performance/trades` | 8048 | ✅ |
| `POST` | `/performance/trades` | 7990 | ✅ |
| `POST` | `/performance/trades/bulk` | 8013 | ✅ |
| `DELETE` | `/performance/trades/{trade_id}` | 8136 | ✅ |
| `GET` | `/performance/trades/{trade_id}` | 8073 | ✅ |
| `PUT` | `/performance/trades/{trade_id}` | 8086 | ✅ |
| `GET` | `/plan` | 8468 | ✅ |
| `POST` | `/plan` | 8496 | ✅ |
| `GET` | `/plan/compliance` | 8531 | ✅ |
| `PATCH` | `/plan/draft` | 8520 | ✅ |
| `GET` | `/plan/history` | 8477 | ✅ |
| `GET` | `/plans` | 4456 | ❌ |
| `GET` | `/portfolio` | 4042 | ❌ |
| `POST` | `/portfolio` | 4050 | ❌ |
...
| `GET` | `/prices` | 3766 | ✅ |
| `GET` | `/public/settings` | 9277 | ✅ |
| `GET` | `/quote/{symbol}` | 10015 | ❌ |
...
| `components/charts/structure/` | 12 | 1,731 |
...
| Fichero | Líneas |
|---|---:|
| `backend/server.py` | 10,458 |
| `frontend/src/pages/EducationPage.jsx` | 5,813 |
| `frontend/src/lib/i18n/ar.js` | 4,936 |
| `frontend/src/lib/i18n/de.js` | 4,936 |
| `frontend/src/lib/i18n/en.js` | 4,936 |
| `frontend/src/lib/i18n/es.js` | 4,936 |
| `frontend/src/lib/i18n/fr.js` | 4,936 |
| `frontend/src/lib/i18n/it.js` | 4,936 |
| `frontend/src/lib/i18n/ja.js` | 4,936 |
| `frontend/src/lib/i18n/pt.js` | 4,936 |
| `frontend/src/lib/i18n/ru.js` | 4,936 |
| `frontend/src/lib/i18n/zh.js` | 4,936 |
