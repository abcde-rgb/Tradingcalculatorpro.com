...
| | |
|---|---:|
| Módulos del backend | 30 |
| Líneas de Python (backend) | 24,843 |
| Rutas declaradas | 205 |
| **Rutas sin consumidor en el frontend** | **43** |
| Ficheros de test · funciones de test | 50 · 821 |
...
| `level_odds.py` | 592 |  | ¿A dónde ha ido el precio DESPUÉS de estar donde está ahora? |
