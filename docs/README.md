...
|---|---|---|
| [`ESTADO_PROYECTO.md`](./ESTADO_PROYECTO.md) | **Fuente de verdad del estado.** Semáforo, inventario, huecos `G-xx`, plan de test y backlog. Criterio, no conteos | 412 |
...
| [`REGISTRO_SESIONES.md`](./REGISTRO_SESIONES.md) | Histórico de 148 sesiones. **No se lee entero** (~5.600 líneas): se busca por fecha o palabra | 5.601 |
